...
use Spatie\UptimeMonitor\Events\RegistrationCheckFailed as InValidRegistrationFoundEvent;
use Spatie\UptimeMonitor\Notifications\BaseNotification;

class RegistrationCheckFailed extends BaseNotification
{
    public InValidRegistrationFoundEvent $event;
    ...
    {
        return "Registration for {$this->getMonitor()->url} is invalid";
    }
}
